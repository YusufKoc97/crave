...
// Re-exported so existing imports `from '@/lib/community'` keep working.
// The implementation lives in lib/relativeTime.ts because it's pure and
// the community module pulls in Supabase, which can't load under Vitest.
